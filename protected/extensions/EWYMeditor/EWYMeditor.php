  ...
  private function _addPlugins( $cs, $assets )
  {
    ...
    $plugins = array(
      ...
      'resizable' => array(
        ...
        'init' => 'wym.resizable();' ),
      'imgmgr' => array(
        'file' => '/plugins/imgmgr/jquery.wymeditor.imgmgr.js',
        'init' => '' ),
    );
    ...
    foreach( $this->plugins as $plugin )
    {
      if( isset( $plugins[$plugin] ) )
      {
        ...
        if ($plugin == 'imgmgr') {
			...
			Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . '/css/jui/jquery-ui.css'); //????
			Yii::app()->clientScript->registerScriptFile($assets . '/plugins/imgmgr/ajaxfileupload.js');
			Yii::app()->clientScript->registerCssFile($assets . '/plugins/imgmgr/imgmgr.css');
		}
      }
    }
