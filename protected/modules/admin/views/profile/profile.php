<?php $this->pageTitle=Yii::app()->name . ' - '.AdminModule::t("Profile");
$this->breadcrumbs=array(
	AdminModule::t("Profile"),
);
?><h2><?php echo AdminModule::t('Your profile'); ?></h2>
...
<?php 
		...
		if ($profileFields) {
			...
			?>
<tr>
	<th class="label"><?php echo CHtml::encode(AdminModule::t($field->title)); ?>
</th>
...
<tr>
    ...
    <td><?php echo CHtml::encode(Admin::itemAlias("UserStatus",$model->status)); //was User
    ?>
</td>
</tr>
</table>
